...
public class LMRParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LMR");
  ...
  { 
    LMRParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LMRParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LMRParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LMRParseControllerGenerated.class);
    }
  ...
  { 
    return LMRParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
